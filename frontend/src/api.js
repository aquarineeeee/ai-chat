...
export const api = {
  ...
  addProjectTool: (id, data) => request('POST', `/api/projects/${id}/tools`, data),
  updateProjectTool: (id, toolId, data) => request('PUT', `/api/projects/${id}/tools/${toolId}`, data),
  deleteProjectTool: (id, toolId) => request('DELETE', `/api/projects/${id}/tools/${toolId}`),
